...
echo -e "${GREEN_TEXT}✅ Testnet successfully connected.${RESET_TEXT}"
...
answer=${answer:-n}  # Default to "n" if no answer is given

case "$answer" in
  y|Y) 
    echo -e "${GREEN_TEXT}✅ Models will be pushed.${RESET_TEXT}"
    # Add your code for "yes" case here
    ;;
  n|N|*) 
    echo -e "${GREEN_TEXT}ℹ️ Models will NOT be pushed to Hugging Face Hub.${RESET_TEXT}"
